#ifndef NETWORK_CLIENT_MACROS_H_INCLUDED
#define NETWORK_CLIENT_MACROS_H_INCLUDED
...
/* The maximum number of clients who can connect at once
 Eventually this should be user-defined - */
#define CHAT_MAXCLIENTS  10

#endif // NETWORK_CLIENT_MACROS_H_INCLUDED
